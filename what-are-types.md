...
Data types such as `int`, `List<int>`, etc. are the types you might be familiar with. Types arise in programming languages and other formalized languages such as the ones used for writing mathematical theorems and their machine-checkable proofs.   
